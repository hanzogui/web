...
var import_createMediaStyle = require("./createMediaStyle.native.js");
...
var import_propMapper = require("./propMapper.native.js");
...
var getSplitStyles = function (props, staticConfig, theme, themeName, componentState, styleProps, parentSplitStyles, componentContext, groupContext, elementType, startedUnhydrated, debug, animationDriver) {
  var _loop = function (keyOg2) {
    ...
    (0, import_propMapper.propMapper)(keyInit, valInit, styleState, disablePropMap, function (key5, val2, originalVal) {
      ...
      isPseudo = key5 in import_helpers.validPseudoKeys;
        ...
        if (shouldDoClasses && !isExit) {
          ...
          try {
            for (var _iterator3 = pseudoStyles[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              ...
              var fullKey = `${psuedoStyle[import_helpers.StyleObjectProperty]}${PROP_SPLIT}${descriptor.name}`;
              addStyleToInsertRules(rulesToInsert, psuedoStyle);
              classNames[fullKey] = psuedoStyle[import_helpers.StyleObjectIdentifier];
            }
          } catch (err) {
        ...
        if (shouldDoClasses) {
          ...
          try {
            for (var _iterator12 = mediaStyles[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
              ...
              classNames[fullKey1] = out[import_helpers.StyleObjectIdentifier];
            }
          } catch (err) {
          ...
          if (isThemeMedia) {
            if (import_constants.isIos && (0, import_config.getSetting)("fastSchemeChange")) {
              var _styleState3;
              ...
              for (var subKey1 in mediaStyle1) {
                ...
                if (existing === null || existing === void 0 ? void 0 : existing.dynamic) {
                  ...
                  var oppositeVal = (0, import_getDynamicVal.extractValueFromDynamic)(existing, oppositeScheme);
            ...
            var groupInfo = (0, import_getGroupPropParts.getGroupPropParts)(mediaKeyShort);
          ...
          for (var subKey2 in mediaStyle1) {
            ...
            if (subKey2[0] === "$") {
              ...
              if (subMediaType === "platform") {
                if (!(0, import_isActivePlatform.isActivePlatform)(subKey2)) continue;
...
function mergeMediaByImportance(styleState, mediaKey, key, value, isSizeMedia, importanceBump, debugProp, originalVal) {
  ...
  var importance = (0, import_useMedia.getMediaImportanceIfMoreImportant)(mediaKey, key, styleState, isSizeMedia);
  if (importanceBump) {
