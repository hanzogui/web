...
(0, import_vitest.describe)("CreateGuiConfig animation types", function () {
  (0, import_vitest.test)("CreateGuiConfig.animations accepts single driver", function () {
    var _driver = {};
  });
  (0, import_vitest.test)("CreateGuiConfig.animations accepts multi-driver object", function () {
    var _multi = {};
  });
});
...
(0, import_vitest.describe)("animatedBy prop", function () {
  (0, import_vitest.test)("animatedBy exists on GuiComponentPropsBaseBase", function () {
  ...
  (0, import_vitest.test)("multi-driver config type flow preserves all driver keys", function () {
    (0, import_vitest.expectTypeOf)().toMatchTypeOf();
    (0, import_vitest.expectTypeOf)().toMatchTypeOf();
  });
});
(0, import_vitest.describe)("Type regression scenarios", function () {
  (0, import_vitest.test)("single driver config scenario", function () {});
  (0, import_vitest.test)("multiple drivers config scenario - CreateGuiConfig accepts it", function () {
    var _config = {};
  });
...
(0, import_vitest.describe)("ExtractAnimationDriverKeys helper", function () {
  (0, import_vitest.test)('single driver returns "default"', function () {
    (0, import_vitest.expectTypeOf)().toEqualTypeOf();
  });
  (0, import_vitest.test)("multi-driver returns all keys", function () {
    (0, import_vitest.expectTypeOf)().toMatchTypeOf();
    (0, import_vitest.expectTypeOf)().toMatchTypeOf();
  });
  (0, import_vitest.test)("multi-driver with css key returns all keys", function () {
    (0, import_vitest.expectTypeOf)().toMatchTypeOf();
    (0, import_vitest.expectTypeOf)().toMatchTypeOf();
  });
});
